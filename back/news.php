    ...
    <table class="table table-dark text-center">
        ...
        <tbody>
            ...
            <tr>
                <td><?=$data['title']?></td>
                <td><?=$type?></td>
                <td><?=mb_substr($data['text'], 0, 50)."..."?></td>
                <td>
                    <input class="form-check-input" type="checkbox" name="display[]" value="<?=$data['id']?>">隱藏&nbsp;
                    <input class="form-check-input" type="checkbox" name="del[]" value="<?=$data['id']?>">刪除&nbsp;
                </td>
            </tr>
